...
| [セットアップ推奨事項](setup)                                  | -                                                                                                                                                                                                                                  | -                                                       |
| 第1章: LLMを理解する                                          | コードなし                                                                                                                                                                                                                             | -                                                       |
| 第2章: テキストデータの扱い方                                 | - [ch02.ipynb](ch02/01_main-chapter-code/ch02.ipynb)<br/>- [dataloader.ipynb](ch02/01_main-chapter-code/dataloader.ipynb)（まとめ）<br/>- [exercise-solutions.ipynb](ch02/01_main-chapter-code/exercise-solutions.ipynb)                     | [./ch02](./ch02)                                        |
